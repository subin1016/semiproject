...
<body>
	<br>
	<div align="center" >
		<form action="commuwriteAf.do" id="frm" method="post" enctype="multipart/form-data">
			<table id="write">
				<!-- 작성자 ID 표시 -->
				<tr>
					<th style="text-align: center;">ID</th>
					<td><input type="text" id="id" name="id" value="<%=login.getId()%>" readonly="readonly"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="title" name="title" placeholder="제목 입력하세요">
				...
				<tr>
					<td colspan="2">
						...
						<div id="editor" contentEditable="true" style="overflow-x: auto; width: 100%; height: 500px; padding: 16px 24px; border: 1px solid #D6D6D6; border-radius: 4px"></div> <textarea hidden="true" id="content" name="content"></textarea>
				...
				<tr>
					<td colspan="2" style="margin: 5px"><input type="file" name="fileload">
						<button type="button" id="sbutton" style="float: right" class="btn btn-secondary btn-sm">작성완료</button>
					</td>
